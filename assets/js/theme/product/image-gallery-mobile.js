...
export default class ImageGallery {
    constructor($gallery) {
        this.$mainCarousel = $gallery.find('[data-image-gallery-main1]');
        this.$navCarousel = $gallery.find('[data-image-gallery-nav1]');

        const $defSlide = this.$mainCarousel.find('.slick-current1');
    ...
    setActiveThumb() {
        ...
        this.$navCarousel
            .find('.slick-slide')
            .removeClass('slick-current1')
            .eq(i)
            .addClass('slick-current1');
    }
    ...
    swapMainImage() {
        ...
        this.$navCarousel.find(`.productView-imageCarousel-nav1-item:eq(${this.defaultSlideIndex}) img`).attr('src', this.currentImage.mainImageUrl);
